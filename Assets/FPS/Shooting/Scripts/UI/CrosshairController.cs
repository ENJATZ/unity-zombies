...
public class Crosshair
{
    ...
    void UpdateSpread()
    {
        ...
        int crosshairDis = (int)(1019.6f * spread) + 5;
        Vector2 xPos = new Vector2(crosshairDis‬, 0);
        Vector2 yPos = new Vector2(0, crosshairDis‬);
        top.anchoredPosition = Vector2.Lerp(top.anchoredPosition, yPos, Time.deltaTime * 4f);
        bottom.anchoredPosition = Vector2.Lerp(bottom.anchoredPosition, -yPos, Time.deltaTime * 4f);
        left.anchoredPosition = Vector2.Lerp(left.anchoredPosition, xPos, Time.deltaTime * 4f);
        right.anchoredPosition = Vector2.Lerp(right.anchoredPosition, -xPos, Time.deltaTime * 4f);
    }
}
